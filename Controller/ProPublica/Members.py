import requests
from ProPublica_Model import Senator, House, RepDetail


def sentatorByStateJSON(state):
...
def houseRepsByStateJSON(state):
...
def parseSenator(senatorJsonData):
