...
class Twitter():
    ...
    def get_rep_information(self):
        client = self.get_twitter_client()
        user = "RepCleaver"
        data = Cursor(client.user_timeline, id=user).items(6)
        return data

    def get_rep_tweet(self):
        repTweetList = []
        parseJson = self.get_rep_information()
    ...
    def get_tweet_user_mention(self):
    ...
    def get_tweetQuote_hashtag(self):
    ...
    def tweet_quote_user_mention(self):
